...
LinkLuaModifier( "modifier_drow_ranger_frost_arrows_lua", "heroes/drow_ranger/drow_ranger_frost_arrows_lua/modifier_drow_ranger_frost_arrows_lua", LUA_MODIFIER_MOTION_NONE )
