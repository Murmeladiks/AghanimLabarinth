...
LinkLuaModifier( "modifier_drow_ranger_multishot_lua", "heroes/drow_ranger/drow_ranger_multishot_lua/modifier_drow_ranger_multishot_lua", LUA_MODIFIER_MOTION_NONE )
